...
enum class AccessibilitySelection {
    DEFAULT, RG_BLIND, MONOCHROME
}
...
class DotsView(context: Context, attrs: AttributeSet) :
    ...
    var accessibility = AccessibilitySelection.DEFAULT
    ...
    fun toggleAccessibility(){
        when(accessibility){
            AccessibilitySelection.DEFAULT -> {
                accessibility = AccessibilitySelection.RG_BLIND
            }
            AccessibilitySelection.RG_BLIND -> {
                accessibility = AccessibilitySelection.MONOCHROME
            }
            AccessibilitySelection.MONOCHROME -> {
                accessibility = AccessibilitySelection.DEFAULT
            }
        }
    }
